...
Files that round-trip with the Ruth Claude.ai research project. The list
...
| file | direction | role |
|---|---|---|
| `biblecore-newbook-test_study_style_reference.md` | repo → project | the artifact contract |
...
| `Ruth-words.tsv` | repo → project | the word table (ids for candidates) |
...
| `source-artifacts/biblecore-newbook-test_NN_translation.html` | project → repo | each unit's artifact |
